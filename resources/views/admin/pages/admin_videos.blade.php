...
@foreach($video_items as $video_item)
			<div class="videos_admin_list_table_item">
				...
				<div class="videos_admin_list_item_cover"><img src="{{asset(env('THEME'))}}/site/img/foto_for_videocover/{{$video_item->img_for_cover}}" alt=""></div>

				<div class="videos_admin_list_item_video">
					<video controls>
				  		<source src="{{asset(env('THEME'))}}/site/video/{{$video_item->portfolio_video}}" type="video/mp4">
